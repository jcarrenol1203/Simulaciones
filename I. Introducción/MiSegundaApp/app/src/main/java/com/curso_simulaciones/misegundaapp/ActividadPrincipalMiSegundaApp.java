...
no en el contenedor, así el fondo sigue llegando hasta el borde)*/
        contenedorPrincipal.setOnApplyWindowInsetsListener((v, insets) -> {
            resultados.setPadding(insets.getSystemWindowInsetLeft(), insets.getSystemWindowInsetTop(),
...
suceso que cumpla que epsilon+1.0=1.0 y el algoritmo
lo sobrepasa.*/
...
lo sobrepasa.*/
        ...
        cadena = cadena + "\n" + " Epsilon double " +epsilonTeoricoDouble+ ", Epsilon double computacional " + epsilonCalculadoDouble;
