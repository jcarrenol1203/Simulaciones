...
public class Acelerometro extends GaugeSimple implements SensorEventListener {
     ...
     * Para las componentes (ax, ay, az) el rango es simétrico [-max, max];
     * para la magnitud total (a) el rango va de 0 a max.
     */
    public void cambiarEscala(float medida) {
        ...
        float minimo = (componenteAceleracion == 4) ? 0f : -maximo;
