...
public class ActividadSecundaria_1 extends Activity {
    ...
    private void crearElementosGUI() {
        ...
        //imagen que ocupa el 90% superior de la pantalla
        imagen = new ImageView(this);
        imagen.setImageResource(R.drawable.imagen_secundaria_uno);
        ...
        editNombreImagen.setText(AlmacenDatosRAM.nombreImagenUno);
    ...
    private LinearLayout crearGUI() {
        ...
        parametros_pegado_imagen.setMargins(0, 0, 0, margenesResolucionIncluida);
    ...
    protected void onPause() {
        AlmacenDatosRAM.nombreImagenUno = editNombreImagen.getText().toString();
