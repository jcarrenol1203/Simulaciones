...
public class ActividadComoClienteBluetooth extends Activity implements Runnable {
   ...
   */
    ...
    private LinearLayout crearGUI() {
        ...
        //Adicionar a la fila 3 el gaussímetro
        LinearLayout.LayoutParams parametrosPegadoGaussimetro = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        linearLayoutFilaTres.setGravity(Gravity.CENTER);
        linearLayoutFilaTres.addView(gaussimetro, parametrosPegadoGaussimetro);
        ...
        botonConectar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (botonConectar.getText() == "CONECTAR") {
                    ...
                    //aviso inmediato: éxito o falla de la conexión
                    textviewAviso.setText(AlmacenDatosRAM.conexion_bluetooth);
    ...
    public void convertirStrigJson(String datoString) {
        ...
        //obtener la información del gaussímetro
        try {
            int componente_campo_magnetico = obj.getInt("componente_campo_magnetico");
            gaussimetro.setComponenteGaussimetro(componente_campo_magnetico);

            float medida_gaussimetro = (float)(obj.getDouble("valor_gaussimetro"));
