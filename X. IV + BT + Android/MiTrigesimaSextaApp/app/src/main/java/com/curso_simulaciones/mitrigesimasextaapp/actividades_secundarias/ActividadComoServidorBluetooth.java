...
public class ActividadComoServidorBluetooth extends Activity implements Runnable {
    ...
    private int componente_campo_magnetico;
    ...
    */
    ...
    private void creacionElementosGUI() {
        ...
        gaussimetro.setColorFranjaDinámica(Color.rgb(0,255,0));
        ...
        editTextRecibir.setText("Despliega la aceleración y el campo magnético sensados por el dispositivo móvil CLIENTE");
    ...
    private LinearLayout crearGUI() {
        ...
        linearLayoutPrincipal.setWeightSum(11f);
        ...
        //LinearLayout segunda fila (acelerómetro + botones ax,ay,az,a)
        ...
        //LinearLayout tercera fila (gaussímetro + botones bx,by,bz,b)
        ...
        //LinearLayout fila 5 (botón empezar)
        ...
        //pegar columnas izquierda y derecha a la fila dos (acelerómetro)
        ...
        //pegar columnas izquierda y derecha a la fila tres (gaussímetro)
        LinearLayout.LayoutParams parametrosColumnaTresIzquierda = new LinearLayout.LayoutParams(0,ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        LinearLayout.LayoutParams parametrosColumnaTresDerecha = new LinearLayout.LayoutParams(0,ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        linearLayoutColumnaTresIzquierda.addView(gaussimetro);

        LinearLayout.LayoutParams parametrosPegadoBotonesCampoMagnetico = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,0);
        parametrosPegadoBotonesCampoMagnetico.weight = 1.0f;
        linearLayoutColumnaTresDerecha.addView(bx,parametrosPegadoBotonesCampoMagnetico);
        linearLayoutColumnaTresDerecha.addView(by,parametrosPegadoBotonesCampoMagnetico);
        linearLayoutColumnaTresDerecha.addView(bz,parametrosPegadoBotonesCampoMagnetico);
        linearLayoutColumnaTresDerecha.addView(b,parametrosPegadoBotonesCampoMagnetico);
   ...
   /*
    ...
    private String getStringJSON(){
        ...
        try {
            ...
            obj.put("valor_acelerometro", acelerometro.getMedida());
            obj.put("componente_campo_magnetico", componente_campo_magnetico);
            obj.put("valor_gaussimetro", gaussimetro.getMedida());
